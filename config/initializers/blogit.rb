...
Blogit.configure do |config|
  ...
  config.authentication_method = :author_required
  ...
  config.rss_feed_title = "Cognate: The business of names"

  # RSS Feed description content
  config.rss_feed_description = "Blog for Cognate, the online trademark database"
